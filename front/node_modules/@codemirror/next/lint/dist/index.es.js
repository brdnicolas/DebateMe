import { Decoration, themeClass, EditorView, ViewPlugin, WidgetType } from '../../view';
import { Annotation, StateField, EditorSelection } from '../../state';
...
/// diagnostics.
const setDiagnostics = Annotation.define();
const setState = Annotation.define();
...
export { closeLintPanel, linter, linting, openLintPanel, setDiagnostics };
