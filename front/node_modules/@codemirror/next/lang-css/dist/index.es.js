...
import { LezerSyntax, indentNodeProp, continuedIndent, foldNodeProp } from '../../syntax';
import { styleTags } from '../../highlight';

/// A syntax provider based on the [Lezer CSS
/// parser](https://github.com/lezer-parser/css), extended with
/// highlighting and indentation information.
const cssSyntax = new LezerSyntax(parser.withProps(indentNodeProp.add({
...
function css() { return cssSyntax.extension; }

export { css, cssSyntax };
